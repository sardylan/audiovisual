...
#ifndef __AUDIOVISUAL__CUSTOMWIDGETS_WATERFALL__TEST__H
#define __AUDIOVISUAL__CUSTOMWIDGETS_WATERFALL__TEST__H

#include <QtTest>

class CustomWidgetsWaterfallTest : public QObject {
Q_OBJECT
